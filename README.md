...
2. Из корня репозитория запустите, например:
   ...
   ```
3. Откройте `http://localhost:3000/game.html` (порт зависит от выбранного сервера).
4. В главном меню выберите «Новая игра» или «Загрузить игру». Настройки доступны из меню или верхней панели хаба.
